...
import { HostUrlPath } from '$src'


describe('HostUrlPath', () => {
  it('parses and exposes origin, pathname, query, anchor', () => {
    const u = new HostUrlPath('https://x.com/foo/bar?a=1#frag')
  ...
  it('throws on invalid URL', () => {
    expect(() => new HostUrlPath('not-a-url')).toThrow(/Invalid URL.*not-a-url/)
    expect(() => new HostUrlPath('http://badc[aracter.com')).toThrow(/Invalid URL/)
  })

  it('join() merges query params and replaces anchor', () => {
    const u = new HostUrlPath('https://x.com/foo?a=a1&b=b1#old')
  ...
  describe('resolve()', () => {
    ...
    it('appends relative paths', () => {
      const u = new HostUrlPath('https://x.com/a/b?x=1#x')
    ...
    it('resets everything on new host', () => {
      const u = new HostUrlPath('https://a.com/a/b?x=1#x')
  ...
  it('replaceOrigin replaces the base host', () => {
    const u = new HostUrlPath('https://a.com/foo')
